...
vim.keymap.set('n', '<leader>rnc', ":w! C:\\Users\\raranjan\\AppData\\Local\\nvim\\init.lua <bar> :source C:\\Users\\raranjan\\AppData\\Local\\nvim\\init.lua<CR>", {desc = '[R]efresh [N]vim [C]onfig', noremap=true})
--
-- -- vim.keymap.set('n', '<leader>z', ':cprev<CR>', {desc = 'Previous in Quickfix'})
-- LSP settings.
